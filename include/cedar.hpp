...
class Cedar {
    ...
    private:
		...
		bool applySetCover(std::vector<double> &strainCnt, std::vector<bool> &strainValid, std::vector<bool> &potentiallyRemoveStrain, double minCnt, bool canHelp, bool verbose = false);
