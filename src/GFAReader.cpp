...
int main(int argc, char* argv[]) {
  ...
  for (auto ppair : name_to_path) {
    ...
    if (tname == "ENST00000335137.3|ENSG00000186092.4|OTTHUMG00000001094.2|"
                 "OTTHUMT00000003223.2|OR4F5-001|OR4F5|918|CDS:1-918|") {
    ...
    for (int i = 0; i < segnames.size(); ++i) {
      ...
      configMap[contig_id].push_back(
          {tnameMap[tname], (pos - i * 31), orientations[i]});
      pos += curr_len;
    }
  }
