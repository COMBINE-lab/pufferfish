...
GFAConverter::convertOld2newPath(std::vector<std::pair<uint64_t, bool> > &oContigVec) {
...
void
GFAConverter::updatePathStart(uint64_t &oStartNodeId, bool oStartNodeOri, uint64_t &nStartNodeId, bool nStartNodeOri) {
