...
~/miniconda3/bin/python ${outdir}/scripts/validate_results.py -truer ${truthfile} -est ${outdir}/results/salmon/pufferfish/${outfile}/quant.sf -truthType microbiome
...
~/miniconda3/bin/python ${outdir}/scripts/taxonomicRanks.py -qf ${outdir}/results/salmon/pufferfish/${outfile}/quant.sf -lf ${outdir}/files/rankedlineage.dmp -od ${outdir}/results/script_results/${outfile}_puff_sal -dt salmon
...
~/miniconda3/bin/python ${outdir}/scripts/validate_results.py -truer ${taxatruthfile} -est ${outdir}/results/script_results/${outfile}_puff_sal/out.tab -truthType taxonomy
